...
public class ChannelController extends StructureController{
    ...
    public ResponseEntity<GeneralResponseDto<DeletedStorageDto>> deleteChannel(@PathVariable Long idChannel) throws AppException {
